 ...
 * ============================
 *
 * 👉 This entity represents a Movie Show.
 * 👉 It is the AGGREGATE ROOT in DDD terms.
 * 👉 It owns the lifecycle of ShowSeat.
 *
 * VERY IMPORTANT CONCEPTS USED HERE:
 * 1️⃣ Cascade
 * 2️⃣ Orphan Removal
 * 3️⃣ Lazy Loading
 * 4️⃣ Controlled object creation (no setters)
 *
 * Interview tip:
...
public class Show {
     ...
     * • Foreign key lives in ShowSeat table (show_id)
     *
     * fetch = LAZY
     * ------------
     * • Seats are NOT loaded unless explicitly accessed
     * • Prevents N+1 problem in listing APIs
     *
     * cascade = ALL
     * -------------
     * • Persist Show → Seats saved automatically
     * • Delete Show → Seats deleted automatically
     * • Merge Show → Seats merged automatically
     *
     * orphanRemoval = true
     * --------------------
     * • If a seat is REMOVED from this list,
     ...
     * • Prevents accidental creation outside domain
     */
    protected Show() {}
     ...
     * • Avoids forgetting to set parent
     *
     * Interview:
